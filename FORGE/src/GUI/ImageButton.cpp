...
ImageButton::ImageButton(const char* imgButId, const std::string idleFile, const std::string hoverFile,
	const std::string pressedFile, SDL_GLContext renderer_, std::function<void(void)> funct, forge::Vector2 size_, forge::Vector2 pos_)
...
ImageButton::ImageButton(const char* imgButId, const std::string fileName, SDL_GLContext renderer_, std::function<void(void)> funct,
