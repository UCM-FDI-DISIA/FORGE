...
public:
	...
	ImageButton(const char* imgButId, const std::string idleFile, const std::string hoverFile,
		const std::string pressedFile, SDL_GLContext renderer_, std::function<void(void)> funct, forge::Vector2 size_,
	...
	/// <param name = "size_">Tamaño de la imagen por pantalla</param>
	/// <param name = "pos_">Posicion de renderizado</param>
	ImageButton(const char* imgButId, const std::string fileName, SDL_GLContext renderer_, std::function<void(void)> funct,
