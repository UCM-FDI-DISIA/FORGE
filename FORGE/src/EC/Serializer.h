...
/// <summary>
/// Interfaz que almacena el nombre de una variable que se va a serializar.
/// </summary>
...
/// <summary>
/// Clase plantilla que almacena e inicializa una variable serializada en Lua o ComponentData.
/// </summary>
...
/// <summary>
/// Clase que se encarga de almacenar e inicializar todas las variables que se quieran serializar de un Component desde un archivo Lua o un ComponentData.
/// </summary>
